...
window.addEventListener('DOMContentLoaded', function () {
  new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.page',
    buttons: '.next'
  }).render();
  new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_0__["default"]('.showup .play', '.overlay').init();
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('#form1', 'assets/question.php').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('#form2', 'assets/question.php').init(); // Modules.html
  ...
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__video-item .play', '.overlay').init();
...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function bindTrigger() {
      ...
      this.items[this.items.length - 1].addEventListener('click', function () {
        if (_this.counter === _this.items.length - 2) {
          var lastItemPos = _this.items.length - 1;

          _this.items[lastItemPos].classList.add('fadeOut');

          _this.items[lastItemPos].style.display = 'none';

          _this.items[lastItemPos].remove();
        }

        _this.items[_this.counter].style.display = 'flex';

        _this.items[_this.counter].classList.add('fadeIn');
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function validateEmailInputs() {
      var emailInputs = this.form.querySelectorAll('[type="email"]');
    ...
    key: "validatePhoneInputs",
    value: function validatePhoneInputs() {
    ...
    value: function bindForm() {
      ...
      this.form.addEventListener('submit', function (e) {
        ...
        _this.form.parentNode.append(statusMessage);

        statusMessage.textContent = _this.message.loading;
        var formData = new FormData(_this.form);

        _this.sendData(_this.path, formData).then(function (res) {
          console.log(res);
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.buttons.forEach(function (button) {
        ...
        button.parentNode.previousElementSibling.addEventListener('click', function (e) {
          e.preventDefault();
          _this2.slideIndex = 1;
      ...
      this.prevs.forEach(function (item) {
      ...
      this.nexts.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        var lastPos = _this2.slides.length - 1;

        if (_this2.slides[lastPos].tagName === 'BUTTON' && _this2.slides[lastPos - 1].tagName === 'BUTTON') {
          for (var i = 0; i < 3; i++) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.buttons.forEach(function (button, i) {
        try {
          var blockedElement = button.closest('.module__video-item').nextElementSibling;
        ...
        button.addEventListener('click', function () {
          if (!button.closest('.module__video-item') || button.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              if (_this.url !== button.getAttribute('data-url')) {
                _this.url = button.getAttribute('data-url');
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElement = this.activeButton.closest('.module__video-item').nextElementSibling;
